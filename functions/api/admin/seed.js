...
export async function onRequestPost(context) {
  ...
  try {
    ...
    await db.prepare(
          "CREATE TABLE client_profiles(id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER, display_name TEXT, bio TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)"
        ).run();
    ...
    // Get user IDs after insert for profile creation - INSERT uses 3 values: (user_id, display_name, bio) to match client_profiles table schema
