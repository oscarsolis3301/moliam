...
/**
 * Validate session token from cookies and return authenticated user object or error Response if unauthorized
...
export async function onRequestPatch(context) {
  ...
  if (!match) return jsonResp(401, { success: false, message: "Not authenticated." }, undefined, request);
