 ...
 * @returns {Response} Empty response with Access-Control-Allow-Origin header
 */
 ...
 * @param {Request|null} request - Optional Request object for origin detection
 * @returns {Response} JSON Response with application/json content type
 */
function jsonResp(status, body, request = null) {
  const headers = new Headers({
    "Content-Type": "application/json",
